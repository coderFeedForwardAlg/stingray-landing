      ...
      <div className='vstack'>
        ...
        <h1 className="heading">
          Stingray, the Most <span style={{ backgroundImage: "linear-gradient(to right, rgb(5, 236, 55) , rgb(22, 120, 43))", color: "transparent", backgroundClip: "text" }}>
            Affordable </span>
          Cloud Computing Alternative for <br /> the <span style={{ backgroundImage: "linear-gradient(to right, rgb(5, 236, 55) , rgb(22, 120, 43))", color: "transparent", backgroundClip: "text" }}>
            AI/ML Era
          </span>
        </h1>

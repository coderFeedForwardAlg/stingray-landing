  ...
  return (
    <div className="hstack">
      <div className='vstack'>
        <h1 className="mobile">Worning: this may look realy bad on mobile!</h1>
        ...
        <h2 className="subheading">Imagine data storage, hosting, GPU clusters, and eazy genAI integration all running on cheap biofuel. Stingray is making this a reality. Sign up for the beta and get a free database! Email max@team-stingray.com to get updates on development progress.</h2>
